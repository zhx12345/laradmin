...
use Zhxlan\Laradmin\Http\Requests\AdvertisementsRequest;
use Zhxlan\Laradmin\Models\AdvertisementsModel;
...
class AdvertisementsController extends BaseController
{
    ...
    {
        $this->modelClass = new AdvertisementsModel();
        $this->requestClass = AdvertisementsRequest::class;
        $this->title = '广告信息';
        $this->initialize();
    }
