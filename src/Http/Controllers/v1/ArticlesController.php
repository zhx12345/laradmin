...
use Zhxlan\Laradmin\Http\Requests\ArticlesRequest;
use Zhxlan\Laradmin\Models\ArticlesModel;
...
class ArticlesController extends BaseController
{
    ...
    {
        $this->modelClass = new ArticlesModel();
        $this->requestClass = ArticlesRequest::class;
        $this->title = '文章';
        $this->initialize();
    }
